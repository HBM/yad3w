...
var LineChart = function () {
  ...
  _createClass(LineChart, [{
    ...
    value: function init() {
      ...
      this.x = (0, _d3Scale.scaleLinear)().domain([0, 8]).range([0, w]);

      this.y = (0, _d3Scale.scaleLinear)().domain([-1, 1]).range([h, 0]);
    ...
    value: function render(data) {
      ...
      (0, _d3Selection.select)('.x.axis').attr('transform', 'translate(0, ' + y(0) + ')');
